...
if len(data) == 19:
  id, title, tagname, author_id, body, node_type, parent_id, abs_parent_id,
  added_at, score, state_string, last_edited_id, last_activity_by_id, 
  last_activity_at,active_revision_id, extra, extra_ref_id, extra_count, marked = data
  addedhour = added_at[11:14]
  print "{0}\t{1}".format(id, addedhour)